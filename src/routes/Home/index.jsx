...
export default class Home extends React.Component {
  ...
  render() {
    const children = [
      ...
      <Content2 id="content_1_1" key="content_1_1" isMode={this.state.isMode}/>,
      <Content3 id="content_1_2" key="content_1_2" isMode={this.state.isMode}/>,
      <Content4 id="content_1_3" key="content_1_3" isMode={this.state.isMode}/>,
      <Content5 id="content_10_0" key="content_10_0" isMode={this.state.isMode}/>,
      <Content6 id="content_10_1" key="content_10_1" isMode={this.state.isMode}/>,
      <Footer id="footer_1_0" key="footer_1_0" isMode={this.state.isMode}/>,
      // 导航和页尾不进入锚点区，如果需要，自行添加;
      <Point key="list" ref="list" data={['content_0_0', 'content_1_0', 'content_1_1', 'content_1_2', 'content_1_3', 'content_10_0', 'content_10_1']} />,
    ];
    return (
